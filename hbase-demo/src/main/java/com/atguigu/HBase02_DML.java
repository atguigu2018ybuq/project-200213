...
public class HBase02_DML {
    ...
    //TODO 新增和修改数据
    public static void putData(String tableName, String rowKey, String cf, String cn, int value) throws IOException {
...
//        delete.addColumn(Bytes.toBytes(cf), Bytes.toBytes(cn));
    ...
    public static void main(String[] args) throws IOException {
        ...
        //测试插入数据
//        putData("stu8", "1004", "info2", "name", 1);

        //测试Get方式获取数据
        getData("stu8", "1004", "info2", "name");
